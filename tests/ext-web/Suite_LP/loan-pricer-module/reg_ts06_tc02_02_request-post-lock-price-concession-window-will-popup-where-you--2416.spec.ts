...
test.describe('Loan Pricer Module', () => {
  ...
  test('REG_TS06_TC02_02_Request Post Lock Price Concession (Window will popup where you can enter Fee Price and select Reason and amount will be applied) Check Fee and Reason are applied correctly Wait for L', async ({ page }) => {
