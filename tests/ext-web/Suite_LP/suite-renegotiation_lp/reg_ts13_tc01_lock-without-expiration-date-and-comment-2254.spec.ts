...
test.describe('Suite: Renegotiation_LP', () => {
  ...
  test('REG_TS13_TC01_Lock without Expiration date and comment', async ({ page }) => {
    ...
    // [DISABLED] Verifying Lock Expiration Days and Handling Weekends
