...
test.describe('Suite: Request_Lock_LP', () => {
  ...
  test('REG_TS07_TC02_01_B_if LD Deny Request it will go back to previous Events', async ({ page }) => {
    // Prerequisite: REG_TS07_TC02_01_A_if LD Deny Request it will go back to previous Events
    ...
    await expect(page.locator("//span[text()=\"test sigma\"]/..//span[text()=\"Request Denied (Pre-Lock)\"]")).toBeVisible();
