...
test.describe('Suite: Add/Edit/Delete Ad-Hoc_adjustments_LP', () => {
  ...
  test('REG_TS16_TC01_01_Verify Add-Adhoc Adjustments Lock Desk is able to add/edit/delete Ad-hocs from pricing on both unlocked and locked loans', async ({ page }) => {
