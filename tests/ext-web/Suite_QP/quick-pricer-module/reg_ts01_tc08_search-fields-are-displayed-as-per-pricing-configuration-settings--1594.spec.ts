...
test.describe('Quick Pricer Module', () => {
  ...
  test('REG_TS01_TC08_Search fields are displayed as per pricing configuration settings for Quick Pricer', async ({ page }) => {
    ...
    if (true) /* Element Configuration Icon is visible */ {
      ...
      if (true) /* Checkbox Show Compensation Type Checkbox is checked */ {
      ...
      if (true) /* Checkbox Default Lock Day(default) is checked */ {
        // [DISABLED] Store checked in DefaultLockDay
        // vars["DefaultLockDay"] = "checked";
      } else {
        // [DISABLED] Store unchecked in DefaultLockDay
      ...
      if (true) /* Checkbox Show Compensation Type(default) is checked */ {
        // [DISABLED] Store checked in ShowCompensationType
        // vars["ShowCompensationType"] = "checked";
      } else {
        // [DISABLED] Store unchecked in ShowCompensationType
        // vars["ShowCompensationType"] = "unchecked";
      }
      ...
      if (true) /* Checkbox PMI (default) is checked */ {
        // [DISABLED] Store checked in PMI
        // vars["PMI"] = "checked";
      } else {
        // [DISABLED] Store unchecked in PMI
        // vars["PMI"] = "unchecked";
      }
