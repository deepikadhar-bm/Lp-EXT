...
test.describe('Unassigned', () => {
  ...
  test('Token generation and store firstName, loanNumber in variable using API_1', async ({ page }) => {
    // API: Generation Token Number to Create Loan API
    const _apiResponse_70774 = await page.request.post("https://api.elliemae.com/oauth2/v1/token");
    const _apiBody_70774 = await _apiResponse_70774.json();
