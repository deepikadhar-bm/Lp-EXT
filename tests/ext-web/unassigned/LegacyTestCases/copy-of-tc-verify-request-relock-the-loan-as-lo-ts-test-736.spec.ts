...
test.describe('Unassigned', () => {
  ...
  test('Copy of (TC: Verify Request relock the loan as  LO) TS TEST', async ({ page }) => {
    ...
    await stepGroups.stepGroup_Copy_of_SG_Search_for_Loan_TS_TEST(page, vars);
    await page.waitForLoadState('networkidle');
    await page.locator("//td[@data-title=\"Loan Number\"]/a[contains(text(),\"240711007\")]").click();
