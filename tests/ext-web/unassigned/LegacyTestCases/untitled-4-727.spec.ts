...
test.describe('Unassigned', () => {
  ...
  test('Untitled 4', async ({ page }) => {
    vars["testdata"] = (() => {
      const d = new Date();
      const opts: Intl.DateTimeFormatOptions = { timeZone: "Asia/Calcutta" };
    ...
    vars["testdata"] = (() => {
      const d = new Date(String(vars["testdata"]));
      d.setDate(d.getDate() + parseInt(String("30")));
    ...
    vars["test data2"] = (() => { const d = new Date(String(vars["testdata"])); d.setDate(d.getDate() + parseInt(String("30"))); return d.toLocaleDateString('en-US'); /* format: MM/dd/yy */ })();
  });
});
