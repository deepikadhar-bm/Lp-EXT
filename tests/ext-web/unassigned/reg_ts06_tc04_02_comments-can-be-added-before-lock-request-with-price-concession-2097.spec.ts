...
test.describe('Unassigned', () => {
  ...
  test('REG_TS06_TC04_02_Comments can be added before Lock Request with Price Concession ny LO(AL)', async ({ page }) => {
    ...
    await stepGroups.stepGroup_Verify_Buttons_After_Lock_Request_with_Price_Concession(page, vars);
